class MotivateController < ApplicationController
  def quotes
    ...
    if @feeling == '..'
      ...
      It gives you FOCUS!'
      @image = 'http://cdn.screenrant.com/wp-content/uploads/Star-Wars-7-Rumor-Emperor-Returning.jpg'
    elsif @feeling == 'Happy'
      ...
      @image = 'http://fc04.deviantart.net/fs70/f/2011/107/c/e/rainbow_nyan_nyan_pop_tart_cat_by_zaithy-d3e8u2k.jpg'
    elsif @feeling == 'Meh'
